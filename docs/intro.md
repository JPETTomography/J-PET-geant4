...
- the mcGeant.root (or any custom name) is created as an output file. It can be processed by the [J-PET Framework](https://github.com/JPETTomography/j-pet-framework-examples) software.
